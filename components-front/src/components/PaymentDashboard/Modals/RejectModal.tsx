  ...
  return (
    ...
    >
      <Box sx={{ px: 3, py: 2, borderBottom: 1, borderColor: 'divider', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <Typography id="reject-dialog-title" variant="h6" sx={{ fontWeight: 'bold', color: 'text.primary' }}>
          Rejeitar Pagamento
        </Typography>
      ...
      <DialogContent sx={{ p: 3, display: 'flex', flexDirection: 'column', gap: 2 }}>
        <Typography id="reject-dialog-description" variant="body2" sx={{ color: 'text.secondary' }}>
      ...
      <DialogActions sx={{ px: 3, py: 2, bgcolor: 'grey.50' }}>
        ...
        <Button onClick={handleConfirm} disabled={!isValid} variant="contained" color="error" sx={{ textTransform: 'none' }}>
          Confirmar Rejeição
        </Button>
      </DialogActions>
    </Dialog>
