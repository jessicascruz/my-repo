...
Executar ideia de app para skills, agente, roles... Antigravity

---
## ERRO / REAVALIAR

Em ManualPaymentDao, lembrar de rever o método de cancelar que faz dois get. Sem eles não conseguimos fazer funcionar.

---
Em termos simples: o `.AsNoTracking()` diz ao Entity Framework Core que ele **não deve monitorar** o que acontece com as entidades retornadas pela consulta.
...
---
- No Endpoint de Cancel Manual Payment, coloquei APP_KEYCLOAK_CANCEL_MANUAL_PAYMENT_POLICY. Preciso ver se preciso criar e como fazer isso.
- 